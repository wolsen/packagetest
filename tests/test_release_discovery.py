...
def test_stage_target_uses_requested_series_window():
    content = """
releases:
  - version: 30.0.0.0b1
    projects:
...
branches:
  ...
  - name: stable/2027.2
    location: 32.0.0.0b1
"""
    release = resolve_release_from_deliverable_yaml(content, openstack_target="2027.1-b1", deliverable_scope="indri")
